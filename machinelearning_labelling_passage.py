# -*- coding: utf-8 -*-
"""
Created on Tue Dec 19 10:42:00 2017
...
df = pd.read_csv("traning_data_160_postag_bigram.csv",header=0, quoting=3)
...
def label_race (row,string):
   if (0.3<= row[string] < 0.5) :
      return 'NOT'
   if (0.5 <= row[string] <= 0.55) :
      return 'POSSIBLY'
...
df_test = pd.read_csv("C:/Drive/FALL2017/NLP/PASSAGE_TFIDF/test_data_passage_161_POSbigram.csv",header=0, quoting=3)
